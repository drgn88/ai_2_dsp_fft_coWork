...
HD_PWD='C:/Users/kccistc/Desktop/FPGA/fft_project/fft_project.runs/vio_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_1.tcl
